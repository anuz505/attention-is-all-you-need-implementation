...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self,value,key,query,mask):
        ...
        # attention_score_shape = (N,n_heads,query_seq_len,keys_seq_len)
        output = torch.einsum("nhql,nlhd->nqhd",[attention_score,values]).reshape(N,query_seq_len,self.n_heads,self.head_dim)
